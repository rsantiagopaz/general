...
/**
* Objeto creado con un {@link qx.ui.basic.Label} y un {@link  qx.ui.form.List}.
* 
* *Ejemplo:*
*
...
*   {value: '5'}
*  ]
*  var lstOpciones = new qx.ui.form.ow.List("Label:",datosEstructura ,true);
*  </pre>
...
qx.Class.define("componente.general.alejandro.ow.List",
{
  ...
  */
	...
	*/
	construct : function (label, structure, vAlign, emptySelected)
	{
		this.base(arguments);
...
//		this.setLayout(new qx.ui.layout.HBox(1));
		...
		this._combo = new qx.ui.form.List();
